...
import { 
  FaFacebook, FaLinkedin, FaYoutube, FaInstagram,
...
const Dashboard = () => {
  ...
  const hasVideoSupport = selectedPlatforms.some(p => ['youtube'].includes(p));
  ...
  const totalPlatforms = 4; // Facebook, Instagram, LinkedIn, YouTube
  ...
  return (
    <div className="min-h-screen bg-white p-6">
      <div className="max-w-7xl mx-auto">
        ...
        {/* Platform Cards - Rectangular with Icon on Left */}
        <div className="mb-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 cursor-pointer">
            {loading ? (
              Array.from({ length: 4 }).map((_, i) => <PlatformCardSkeleton key={i} />)
            ) : (
